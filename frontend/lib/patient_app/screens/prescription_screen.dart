...
import '../services/patient_prescription_service.dart';
...
class _PrescriptionScreenState extends State<PrescriptionScreen> {
  ...
  void initState() {
    ...
    // TODO: replace with the real logged-in patient id
    const String patientId = 'PASTE_PATIENT_ID_HERE';

    _futurePrescription =
        PatientPrescriptionService.getLatestPrescription(patientId);
  }
              ...
              child: Container(
                ...
                child: FutureBuilder<Prescription?>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return _buildPrescriptionContent(prescription);
                  },
                ),
              ),
            ),
  ...
  Widget _buildPrescriptionContent(Prescription prescription) {
    return SingleChildScrollView(
      child: Column(
        children: [
          // Doctor Info (dummy for now – backend doesn’t send doctor fields yet)
          Row(
            children: [
              Container(
                width: 45,
            ...
            child: Column(
              children: [
                ...
                for (final m in prescription.medicines)
                  _tableRow(m.name, m.dose, m.duration),
              ],
            ),
          ),
          ...
          // Download PDF button (still dummy – UI only)
          ElevatedButton(
            onPressed: () {},
